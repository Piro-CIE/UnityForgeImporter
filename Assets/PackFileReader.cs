...
public class PackFileReader : InputStream 
{
    ...
    protected ISvfManifestType[] _types {get; set; } //ensure type is ok

    //(_buffer[0] == 31 && _buffer[1] == 139) ? GZip.Decompress(_buffer, newBuffer) : _buffer
    ...
    public ISvfTransform? getTransform() {
        ...
        switch (xformType) {
            ...
            case 1: // rotation & translation
                ...
                t = this.getVector3D();
                s = new Vector3(1, 1, 1); //{ x: 1, y: 1, z: 1 };
